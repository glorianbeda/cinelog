...
class ReviewController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            // Review fields
            'rating_overall' => ['required', 'numeric', 'min:0.5', 'max:10.0'],
            'rating_story' => ['nullable', 'numeric', 'min:0.5', 'max:10.0'],
            'rating_visual' => ['nullable', 'numeric', 'min:0.5', 'max:10.0'],
            'rating_acting' => ['nullable', 'numeric', 'min:0.5', 'max:10.0'],
            'rating_audio' => ['nullable', 'numeric', 'min:0.5', 'max:10.0'],
        ...
        if (! $movie) {
            $movie = MovieSeries::create([
                ...
                'release_year' => $validated['release_year'] ?? (!empty($validated['release_date']) ? (int) substr($validated['release_date'], 0, 4) : null),
