                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                        <div>
                            ...
                            <input type="number" 
                                   ...
                                   value="{{ old('runtime_minutes', $watchlistPreFill?->movieSeries?->runtime_minutes) }}" 
                        ...
                        <div>
                            ...
                            <input type="number" 
                                   ...
                                   name="total_seasons" 
                                   value="{{ old('total_seasons', $watchlistPreFill?->movieSeries?->total_seasons) }}" 
                        ...
                        <div>
                            ...
                            <input type="number" 
                                   ...
                                   name="total_episodes" 
                                   value="{{ old('total_episodes', $watchlistPreFill?->movieSeries?->total_episodes) }}" 
